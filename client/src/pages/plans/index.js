...
import { SectionHeading, Subheading as SubheadingBase } from "../../assets/shared/Headings.js";
import { SectionDescription } from "../../assets/typography/Typography";
import { PrimaryButton as PrimaryButtonBase } from "../../assets/shared/Buttons.js";
import { Container, ContentWithPaddingXl } from "../../assets/shared/Layouts.js";
...
const PlansContainer = tw.div`flex justify-center flex-col 
md:flex-row items-center md:items-start relative`;
const Plan = styled.div`
  ${tw`w-full max-w-xl mt-16 md:mr-12 md:last:mr-0 text-center px-8 
...
const Plans = ({
   ...
   planDurations = [
    ...
    return (
        <Box sx={{ width: '576px', margin: '0 auto'}}>
            <Container>
